...
<script type="text/javascript">
   ...
   * @void
   */
  function updateSelect(name, data, keepFirstOption, selected, presentNullAsThis, parentEntityName) {
    var rselect = $('#' + name).get(0);
    var items = data;

    // If a parent entity has been selected, don't show the "Choose $parentEntityName" field, otherwise do
    if ($('#' + 'entity :selected').text() == parentEntityName)
